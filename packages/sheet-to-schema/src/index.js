...
async function get(workbook, sheet, schemaLang = 'zod') {
  if (!workbook) {
  ...
  const langInterface = await require(`./adapter/${schemaLang}.js`)

  return langInterface.get(data)
}
 ...
 * @note File generated by sheet-to-schema.
 * @see https://github.com/zachwatkins/pdf-data-js/tree/main/packages/sheet-to-schema
 */
${schema}
